...
public class PlayerArea : Area
{
    ...
    /*
    public void AddBabyPenguins()
    {
        safeArea.transform.position = ChooseRandomPosition(safeArea.transform.position, 0f, 360f, 0f, 50f) + Vector3.up * .5f; ;
        safeArea.transform.rotation = Quaternion.Euler(0f, UnityEngine.Random.Range(0f, 360f), 0f);
    }
    */
    /*
